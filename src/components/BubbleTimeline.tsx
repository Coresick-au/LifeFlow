...
import { Star, MapPin, Calendar, Play, Pause, RotateCcw } from 'lucide-react';
...
const getCategoryColor = (tags: string[]) => {
  const categoryColors: Record<string, string> = {
    ...
    giving: 'bg-teal-500',
    tradition: 'bg-red-500',
    gratitude: 'bg-red-500',
    nature: 'bg-emerald-500',
    home: 'bg-emerald-500',
    resolution: 'bg-cyan-500',
    goals: 'bg-cyan-500',
    milestone: 'bg-violet-500',
    celebration: 'bg-violet-500',
    relaxation: 'bg-lime-500',
    mindfulness: 'bg-lime-500',
  };
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-2 py-1 border border-theme rounded text-sm"
              >
                          ...
                          return (
                            <g key={category}>
                              <path
                                ...
                                className={`${getCategoryColor([category])} opacity-80 hover:opacity-100 transition-opacity cursor-pointer`}
                              />
                        ...
                        return (
                          <div
                            ...
                            className={`relative group cursor-pointer transition-all duration-200 hover:scale-110 ${
                              isHighlighted ? 'animate-pulse ring-4 ring-primary-300 ring-opacity-50' : ''
                            }`}
